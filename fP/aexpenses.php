...
<div id="log">
<a href="aindex.php">Home</a> |<a href="Employee.php"> Employee </a>| <a href="aprod-categories.php">Product Categories</a> |Expenses| <a href="breports.php">Reports</a> | <a href="admin_logout.php">Logout</a>
</div>
<div id="formdesign">
<input type="text" name="filter" value="" id="filter" placeholder="Search Employee..." autocomplete="off" />
<a rel="facebox" href="addexp.php" id="add">Record Expense</a>
</div>
<table cellspacing="0" cellpadding="2" id="resultTable">
<thead>
	<tr>
		<th width="30%">Spent Date </th>
		<th width="30%">spend Description</th>
		<th width="30%">Money Spent</th>
		<th width="20%"> Action </th>
	</tr>
</thead>
<tbody>
	<?php		
		$result = $boot->selectAll("SELECT * FROM expenses e
		    ORDER BY id DESC");
	...
	<tr class="record">
		...
		<td><?=$row['cost'];?></td>
		<td><a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete">Delete</a>|<a rel="facebox" href="expedit.php?id=<?php echo $row['id']; ?>" class="editbutton" title="Click To Edit">Edit</a></td>
	</tr>
	<?php
		}
	?>
